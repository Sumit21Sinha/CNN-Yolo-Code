...
def filtering(old_array, new_array, array2):
    ...
    return result
result = filtering(image, new_image, kernel)
print(result)
def relu(array):
...
print(pooled_matrix)
new_image2=padding(pooled_matrix, 1)
filtered_matrix=filtering(pooled_matrix, new_image2, kernel2)
relu_output2=relu(filtered_matrix)
finalMatrix=max_pool(relu_output2,2,1)
print(finalMatrix)